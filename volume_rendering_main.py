...
def render_images(
    ...
    for cam_idx, camera in enumerate(cameras):
        ...
        if cam_idx == 0 and file_prefix == '':
            ...
            all_images.append(render_cloud(torch.reshape(pts, (pts.shape[0] * pts.shape[1], 3)), False, "cuda")) # shape change: (H*W, n_points, 3) => (H*W*n_points, 3)
...
def render(
    ...
    imageio.imsave('images/part_1_pc.png', np.uint8(all_images[2] * 255))
